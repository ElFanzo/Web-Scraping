...
PROXIES = [
    ...
    'http://138.68.240.218:8080', 'http://138.68.24.145:8080', 'http://138.68.232.41:8080',
    'http://138.68.240.218:3128', 'http://138.68.24.145:3128', 'http://138.68.161.14:8080', 'http://138.68.169.8:8080'
]
...
def getUserAgent():
    return next(USER_AGENTS_POOL)


def getProxy():
    return next(PROXIES_POOL)